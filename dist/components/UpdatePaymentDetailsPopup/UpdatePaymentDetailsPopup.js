...
var UpdatePaymentDetailsPopup = function UpdatePaymentDetailsPopup(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_InnerPopupWrapper.default, {
    ...
    height: 90
  }, _definedPaymentMethods.default.map(function (item) {
    var IconComponent = item.icon ? item.icon : _react.default.Fragment;

    if (publisherPaymentMethods && publisherPaymentMethods[item.paymentGateway]) {
      return /*#__PURE__*/_react.default.createElement(_UpdatePaymentDetailsPopupStyled.PaymentMethodStyled, {
        key: item.key,
      ...
      }, /*#__PURE__*/_react.default.createElement(_UpdatePaymentDetailsPopupStyled.PaymentMethodIconStyled, null, /*#__PURE__*/_react.default.createElement(IconComponent, null)), /*#__PURE__*/_react.default.createElement(_UpdatePaymentDetailsPopupStyled.PaymentMethodTextStyled, null, /*#__PURE__*/_react.default.createElement(_UpdatePaymentDetailsPopupStyled.PaymentMethodTitleStyled, null, t(item.title)), /*#__PURE__*/_react.default.createElement(_UpdatePaymentDetailsPopupStyled.PaymentMethodDescStyled, null, t(item.description))));
    }
