...
var AddPayPal = function AddPayPal(_ref) {
  var selectedPaymentMethod = _ref.selectedPaymentMethod,
  ...
  var addPayPalPaymentDetails = function addPayPalPaymentDetails() {
    ...
    setIsError(false);
    (0, _updatePayPalPaymentDetails.default)(publisherPaymentMethods.paypal, selectedPaymentMethod.id).then(function (resp) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_InnerPopupWrapperStyled.ContentStyled, null, /*#__PURE__*/_react.default.createElement(_InnerPopupWrapperStyled.TitleStyled, null, "PayPal"), /*#__PURE__*/_react.default.createElement(_InnerPopupWrapperStyled.TextStyled, null, t('Paying with PayPal is easy. Click the button below and sign in to your PayPal account')), /*#__PURE__*/_react.default.createElement(_Button.default, {
    size: "normal",
    width: "50%",
