...
var refreshTokenMock = '123daffsd432grerg31as41ergerg1';
  ...
  describe('@onSubmit', function () {
    it('should login with offerId when fields valid', function (done) {
      ...
      setImmediate(function () {
        ...
        expect(_auth.default.login).toHaveBeenCalledWith(false, false, mockEmailValue, jwtMock, refreshTokenMock, null, null, onSuccessMock);
        done();
      });
    });
    it('should login to my account when fields valid', function (done) {
      ...
      setImmediate(function () {
        ...
        expect(_auth.default.login).toHaveBeenCalled();
        expect(_auth.default.login).toHaveBeenCalledTimes(1);
        expect(_auth.default.login).toHaveBeenCalledWith(true, false, mockEmailValue, jwtMock, refreshTokenMock, null, null, onSuccessMock);
        done();
      });
    });
