...
var LoginForm = /*#__PURE__*/function (_Component) {
  ...
  function LoginForm(props) {
    ...
    _this.login = /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
      var _this$props, offerId, setOfferError, isMyAccount, publisherId, onSuccess, _this$state4, email, password, loginBy, response;

      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this$props = _this.props, offerId = _this$props.offerId, setOfferError = _this$props.setOfferError, isMyAccount = _this$props.isMyAccount, publisherId = _this$props.publisherId, onSuccess = _this$props.onSuccess;
...
LoginForm.propTypes = {
  ...
  setOfferError: _propTypes.default.func,
