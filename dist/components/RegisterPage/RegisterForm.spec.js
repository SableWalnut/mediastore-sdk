  ...
  describe('@events', function () {
    ...
    it('should call onSubmit cb when fields valid', function (done) {
      ...
      setImmediate(function () {
        ...
        expect(_auth.default.login).toHaveBeenCalledWith(false, true, mockEmailValue, jwtMock, refreshTokenMock, _submitConsents.default, [mockConsentValue, mockConsentDefinitions], onSuccessMock);
