...
var TransactionListStyled = _styledComponents.default.div.attrs(function () {
  ...
  return props.length && (0, _styledComponents.css)(_templateObject7 || (_templateObject7 = (0, _taggedTemplateLiteral2.default)(["\n      height: ", ";\n    "])), props.length === 1 ? '33px' : props.length === 2 ? '103px' : "".concat((props.length - 2) * 70 + 103, "px"));
});

exports.TransactionListStyled = TransactionListStyled;

var LeftBoxStyled = _styledComponents.default.div(_templateObject8 || (_templateObject8 = (0, _taggedTemplateLiteral2.default)(["\n  max-width: 70%;\n"])));

exports.LeftBoxStyled = LeftBoxStyled;

var RightBoxStyled = _styledComponents.default.div(_templateObject9 || (_templateObject9 = (0, _taggedTemplateLiteral2.default)(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  margin-left: 20px;\n  text-align: right;\n"])));
...
var ButtonTextStyled = _styledComponents.default.span.attrs(function () {
  ...
  return props.isExpanded && (0, _styledComponents.css)(_templateObject15 || (_templateObject15 = (0, _taggedTemplateLiteral2.default)(["\n        transform: scaleY(0.8) rotateX(180deg);\n      "])));
});
