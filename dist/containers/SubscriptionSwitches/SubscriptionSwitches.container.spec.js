...
var _SubscriptionSwitches = require("./SubscriptionSwitches.container");
...
describe('<PaymentInfo/>', function () {
  it('should show previously added value', function () {
    ...
    expect((0, _SubscriptionSwitches.mapStateToProps)(initialState).planDetails).toEqual(currentPlanMock);
  });
  it('should dispatch SET_CURRENT_PLAN action', function () {
    var dispatch = jest.fn();
    (0, _SubscriptionSwitches.mapDispatchToProps)(dispatch).setCurrentPlan();
  ...
  it('should dispatch SHOW_INNER_POPUP action', function () {
    var dispatch = jest.fn();
    (0, _SubscriptionSwitches.mapDispatchToProps)(dispatch).showInnerPopup();
    expect(dispatch.mock.calls[0][0]).toEqual({
  ...
  it('should dispatch HIDE_INNER_POPUP action', function () {
    var dispatch = jest.fn();
    (0, _SubscriptionSwitches.mapDispatchToProps)(dispatch).hideInnerPopup();
    expect(dispatch.mock.calls[0][0]).toEqual({
  ...
  it('should dispatch UPDATE_LIST action', function () {
    var dispatch = jest.fn();
    (0, _SubscriptionSwitches.mapDispatchToProps)(dispatch).updateList();
    expect(dispatch.mock.calls[0][0]).toEqual({
  ...
  it('should dispatch SET_OFFER_TO_SWITCH action', function () {
    var dispatch = jest.fn();
    (0, _SubscriptionSwitches.mapDispatchToProps)(dispatch).setOfferToSwitch();
    expect(dispatch.mock.calls[0][0]).toEqual({
  ...
  it('should dispatch SET_SWITCH_SETTINGS action', function () {
    var dispatch = jest.fn();
    (0, _SubscriptionSwitches.mapDispatchToProps)(dispatch).setSwitchSettings();
    expect(dispatch.mock.calls[0][0]).toEqual({
