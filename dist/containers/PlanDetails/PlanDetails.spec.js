...
var _PlanDetails = require("./PlanDetails.component");
...
describe('<PlanDetails/>', function () {
  ...
  describe('@componentDidMount', function () {
    it('should set state when fetchSubscriptions return error', function (done) {
      ...
      (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_PlanDetails.PurePlanDetails, defaultProps));
    ...
    it('should hide survey on switch tabs', function () {
      (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_PlanDetails.PurePlanDetails, (0, _extends2.default)({}, defaultProps, {
        planDetails: {
          isSurveyShown: true,
          currentPlan: ['mock']
        },
  ...
  describe('@actions', function () {
    it('should render updateSubscription popup', function () {
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_PlanDetails.PurePlanDetails, (0, _extends2.default)({}, defaultProps, {
        planDetails: {
          currentPlan: [1],
          switchSettings: {
            id: [{
