...
jest.mock("../../api/Customer/getCustomerConsents"); // jest.mock('services/auth', () => ({
...
describe('<MyAccount/>', function () {
  ...
  describe('@renders', function () {
    it('should fetch currentPlan, customer and consents on componentDidMount', function (done) {
      ...
      (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_MyAccount.default, (0, _extends2.default)({}, defaultProps, {
        planDetails: {
          currentPlan: []
        },
        userProfile: {
  ...
  describe('@update', function () {
    ...
    it('should render notCheckedTerms popup', function () {
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_MyAccount.default, (0, _extends2.default)({}, defaultProps, {
        planDetails: {
          currentPlan: subscriptionsData.items
        },
        userProfile: {
