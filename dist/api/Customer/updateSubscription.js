...
var updateSubscription = function updateSubscription(params) {
  var API_URL = (0, _environmentHelper.default)();
  var customerId = (0, _appConfigHelper.getData)('CLEENG_CUSTOMER_ID') || '';
  var url = "".concat(API_URL, "/customers/").concat(customerId, "/subscriptions");
...
var _default = updateSubscription;
