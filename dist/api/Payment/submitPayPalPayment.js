      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            redirectUrls = {
              successUrl: (0, _appConfigHelper.getData)('CLEENG_PP_SUCCESS') || "".concat(window.location.origin, "/thankyou"),
              cancelUrl: (0, _appConfigHelper.getData)('CLEENG_PP_CANCEL') || "".concat(window.location.origin, "/offer"),
              errorUrl: (0, _appConfigHelper.getData)('CLEENG_PP_ERROR') || "".concat(window.location.origin, "/offer")
            };
            _context.prev = 4;
            _context.next = 7;
